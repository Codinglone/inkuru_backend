...
import {postBlogController, getBlogsController, getSingleBlogController} from "../controllers/Blogs.controller";
...
export const getSingleBlogOpts = {
    schema: {
        response: {
            200: getBlogsSchema
        }
    },
    handler: getSingleBlogController
}